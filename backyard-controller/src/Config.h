...
// ===== COMMANDS TO SEND =====
constexpr const char *CMD_CORRECT = "MTG_correct";
constexpr const char *CMD_INCORRECT1 = "MTG_incorrect1";
constexpr const char *CMD_INCORRECT2 = "MTG_incorrect2";
constexpr const char *CMD_INCORRECT3 = "MTG_incorrect3";
constexpr const char *CMD_INCORRECT4 = "MTG_incorrect4";
constexpr const char *CMD_INCORRECT5 = "MTG_incorrect5";
constexpr const char *CMD_INCORRECT6 = "MTG_incorrect6";
constexpr const char *CMD_INCORRECT7 = "MTG_incorrect7";
constexpr const char *CMD_INCORRECT8 = "MTG_incorrect8";
...
constexpr const char *CMD_TABLE[NUM_REEDS_PER_SLIDER][NUM_REEDS_PER_SLIDER] = {
    ...
    // S2: P1               P2              P3
    {CMD_INCORRECT1, CMD_INCORRECT2, CMD_INCORRECT3}, // S1:  P1
    {CMD_INCORRECT4, CMD_CORRECT, CMD_INCORRECT5},    //      P2
    {CMD_INCORRECT6, CMD_INCORRECT7, CMD_INCORRECT8}, //      P3
};
